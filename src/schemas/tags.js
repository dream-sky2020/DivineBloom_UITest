...
// 使用 Vite 的 glob 导入功能自动加载 @data/tags 下的所有 .js 文件
const modules = import.meta.glob('@data/tags/*.js', { eager: true })
import { TagSchema, createMapValidator, TagRegistry } from './index.js'
