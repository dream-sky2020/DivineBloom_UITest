export default {
  'character_slime': {
    ...
    skills: ['skill_enemy_slime_shot', 'skill_passive_attack_up'], // Slime Shot (Active) + Attack Up (Passive)
  ...
  'character_vampire_bat': {
    ...
    skills: ['skill_enemy_vampiric_bite'], // Vampiric Bite
    spriteId: 'default',
  ...
  'character_wasteland_wolf': {
    ...
    skills: ['skill_enemy_pack_bite', 'skill_passive_attack_up'], // Pack Bite + Attack Up
    spriteId: 'default',
  ...
  'character_heavy_guard': {
    ...
    skills: ['skill_enemy_shield_bash', 'skill_support_shield'], // Shield Bash + Shield (Buff)
    spriteId: 'default',
